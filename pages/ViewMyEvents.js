    ...
    return (
      <React.Fragment>
        <View style={{ display: 'flex', flexDirection: 'row', position: 'absolute', zIndex: '1' }}>
          <View onClick={() => this.props.navigation.navigate('Calendar', {fromMyEvent: true})}  style={{ flex: 1, textAlign: 'right' }}>
            <View style={{ margin: 12 }}>
              <View style={{ 'overflow': 'none', 'zIndex': 1,'position': 'fixed', 'top': 5, 'right': 50, 'background': "#fff", padding: 6, display: 'inline-block', border: '1px solid #ff9900', borderTopRightRadius: 8, borderBottomRightRadius: 8 }}><Ionicons name={"ios-calendar"} size={30} color={"#666"} /></View>
              <View style={{ 'overflow': 'none', 'zIndex': 1,'position': 'fixed',  'top': 5, 'right': 85, 'background': "#ff9900", padding: 6, display: 'inline-block', border: '1px solid #ff9900', borderTopLeftRadius: 8, borderBottomLeftRadius: 8 }}><Ionicons name={"ios-list"} size={30} color={"#fff"} /></View>
            </View>
          </View>
        </View>
